...
function App() {
  ...
  useEffect(() => {
    const onClick = (event) => {
      ...
      if (toggleButton) {
        const hiddenContent = toggleButton.nextElementSibling;

        hiddenContent.style.display = hiddenContent.style.display === 'block' ? 'none' : 'block';
        toggleButton.textContent = hiddenContent.style.display === 'block' ? 'Collapse Details' : 'View More Details';
        return;
      }
...
function ProjectsPage() {
  return (
    <section id="projects-page">
      ...
      <p>
        Developed a systematic bond allocation engine that integrates macroeconomic regime classification with price-based
        momentum to drive allocation decisions across a US fixed-income universe.
      </p>
