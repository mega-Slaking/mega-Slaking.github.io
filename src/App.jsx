...
const BLOG_POSTS = [
  {
    ...
    body: [
      'I studied physics and chemistry at university for a simple reason: I love understanding how things work at the lowest level, and I love a hard problem. What I did not do was leave university and walk straight into a quant graduate program. The honest reason is that I had no idea what a quant even was at the time. The path I am on now is something I found gradually, not something I planned from the start.',
